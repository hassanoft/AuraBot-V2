...
//____________________________________________________________________________________________________________________________________________  
  ...
  STICKER_DATA: process.env.STICKER_DATA || '🤖ᴀᴜʀᴀ-ʙᴏᴛ;H$Λ🍀',
  ALIVE_DATA: process.env.ALIVE_DATA || '👋 ʜᴇʏ &sender, ɪ ᴍ *ᴀᴜʀᴀ-ʙᴏᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ* ᴀʟɪᴠᴇ ɴᴏᴡ!\n\n📌 ᴛʏᴘᴇ *menu* ᴛᴏ ɢᴇᴛ ᴍʏ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ.\n\n*ᴘʟᴀᴛꜰᴏʀᴍ:* &platform\n*ʀᴜɴᴛɪᴍᴇ:* &runtime;https://i.ibb.co/pBwr9245/robot-vectoriel-graident-ai-78370-4114.jpg',
  AUDIO_DATA: process.env.AUDIO_DATA || 'AURA-BOT;H$Λ;https://i.ibb.co/pBwr9245/robot-vectoriel-graident-ai-78370-4114.jpg',
  BOT_INFO: process.env.BOT_INFO || 'ᴀᴜʀᴀ-ʙᴏᴛ;H$Λ;2250500525480;https://i.ibb.co/pBwr9245/robot-vectoriel-graident-ai-78370-4114.jpg', 
  ...
  SUDO: process.env.SUDO || '2250500525480',
